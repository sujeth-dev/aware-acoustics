...
| 5 | **Q-08 / Q-09 — project proof** | All 74 projects are published at `tier: record`, `year: null`, 0 targets/measured (the deck has none). Homepage Selected Work / Verification use marked dev fixtures | Client supplies year, status, scope + target/measured pairs for ≥2 (4 recommended) projects | PROJECT_DATA.md, CONTENT_PLAN.md H-03/H-05 |
| 6 | **Q-04 — client naming permission** | **Closed 2026-09-19** by the site owner's statement; all 74 records `clientPublic: true` | Keep a written record on file (PROJECT_DATA §4) | DEC-010, DEC-018 |
